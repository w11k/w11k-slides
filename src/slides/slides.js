(function () {
  ...
  module.factory('SlidesService', ['slidesConfig', '$location', '$rootScope', function (slidesConfig, $location, $rootScope) {
    var activeSlide;
  ...
  module.controller('SlidesCtrl', ['$scope', 'SlidesService', function ($scope, SlidesService) {
    $scope.slides = SlidesService.getSlides();
  }]);


  module.directive('w11kSlideMaster', ['slidesConfig', function (slidesConfig) {
